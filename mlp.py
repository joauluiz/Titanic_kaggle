...
def prints_current_situation (accuracy,k):
    print(Message_Best.ACCURACY, round(accuracy * 100, 2), "%")

    print(Message_Best.Model)
...
def var_best_parameters(function, solver, numb_neur, accuracy, model):
    ...
    return Best_Model_Parameters(best_function, best_solver, best_number_neurons, best_accuracy, best_model)

def prints_best_parameters (best_accuracy, best_function, best_solver, best_number_neurons):

    print(message_best_ACCURACY.value, round(best_accuracy * 100, 2), "%")
